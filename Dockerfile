...
FROM rstudio/r-base:4.4.0-jammy
...
RUN chmod -R 777  /opt/R/4.4.0/lib/R/library/INLA/
RUN chmod -R 777 /opt/R/4.4.0/lib/R/library
RUN chmod -R 777 /opt/R/4.4.0/lib/R/
#USER apprunner
